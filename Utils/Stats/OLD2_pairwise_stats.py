...
-------
>>> import numpy as np
>>> from Utils.Stats.pairwise_stats import compare_groups
>>>
>>> data = {
...
TestFunction = Callable[[np.ndarray, np.ndarray, str], tuple[float, float]]
...
def compare_groups(
    ...
    *,
    ...
    test
        Statistical test to use. Built-in choices are:
    ...
    # Normalize test name and resolve aliases.
    ...
    paired = bool(test_information["paired"])
    display_name = str(test_information["display_name"])
