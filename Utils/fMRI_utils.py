...
def sortByRSN(subjectBOLD, RSNNames):
    allNames = list(set(RSNNames))  # no repeated entries
    res = {}
    for name in allNames:
        ids = [pos for pos, rsn in enumerate(RSNNames) if rsn == name]
        res[name] = subjectBOLD[ids]
